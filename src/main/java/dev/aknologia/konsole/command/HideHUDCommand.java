...
public class HideHUDCommand implements Command {
    public String name = "hidehud";
    public String description = "Hide/Show your HUD.";
    ...
    public int run(CommandContext context) throws CommandSyntaxException {
        KonsoleClient.CLIENT.options.hudHidden = BoolArgumentType.getBool(context, "value");
        return 1;
    }
