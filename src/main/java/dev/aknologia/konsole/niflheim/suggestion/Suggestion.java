...
public class Suggestion implements Comparable<Suggestion> {
    ...
    public Suggestion(final StringRange range, final String text) { this(range, text, null); }
    ...
    public Message getTooltip() { return tooltip; }
    ...
    @Override
    public int hashCode() { return Objects.hash(range, text, tooltip); }
    ...
    @Override
    public int compareTo(final Suggestion o) { return text.compareTo(o.text); }

    public int compareToIgnoreCase(final Suggestion b) { return text.compareToIgnoreCase(b.text); }
